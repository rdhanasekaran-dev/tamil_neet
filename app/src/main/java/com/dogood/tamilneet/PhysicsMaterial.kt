...
class PhysicsMaterial : AppCompatActivity() {
    ...
    private fun addData(){
        ...
        recyclerview.adapter = PhysicsMaterial.ChapterAdapter(this, chaptersList11,unitNumberList1)
        recyclerview1.adapter = PhysicsMaterial.ChapterAdapter(this, chaptersList12,unitNumberList2)
    }
    ...
    class ChapterAdapter(private val context: PhysicsMaterial, private val chaptersList: ArrayList<String>,private val unitNumberList:ArrayList<String>) :
