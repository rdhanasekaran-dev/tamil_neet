...
import kotlinx.android.synthetic.main.activity_chemistry_material.*
import kotlinx.android.synthetic.main.material_layout_file.view.*
import java.util.ArrayList

class ChemistryMaterial : AppCompatActivity() {
    ...
    private fun addData(){
        ...
        recyclerview.adapter = ChemistryMaterial.ChapterAdapter(this, chaptersList11,unitNumberList1)
        recyclerview1.adapter = ChemistryMaterial.ChapterAdapter(this, chaptersList12,unitNumberList2)
    }
    ...
    class ChapterAdapter(private val context: ChemistryMaterial, private val chaptersList: ArrayList<String>,private val unitNumberList:ArrayList<String>) :
